...
//get resume api - called from ViewResume , when page load(), insied useeffect hook
...
// get history api- called from History component , when page load(), insied useeffect hook
